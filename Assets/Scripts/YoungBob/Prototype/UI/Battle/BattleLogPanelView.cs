...
namespace YoungBob.Prototype.UI.Battle
{
    internal sealed class BattleLogPanelView
    {
        ...
        {
            var root = UiFactory.CreatePanel(parent, "BattleLogPanel", new Color(0.04f, 0.06f, 0.08f, 0.92f), new Vector2(0f, 0.27f), new Vector2(1f, 0.41f), new Vector2(10f, 6f), new Vector2(-10f, -2f));
            root.GetComponent<Image>().raycastTarget = false;
            root.GetComponent<Image>().type = Image.Type.Sliced;

            var band = UiFactory.CreatePanel(root.transform, "BroadcastBand", new Color(0.08f, 0.13f, 0.17f, 0.74f), new Vector2(0f, 0.72f), new Vector2(1f, 1f), Vector2.zero, Vector2.zero);
